...
import { Monitor, Smartphone, Tablet, RefreshCw, Eye, Code2 } from 'lucide-react';
...
${htmlCode}
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-stone-200 bg-white shadow-xs">
      ...
      <div className="flex flex-wrap items-center justify-between border-b border-stone-200 bg-stone-50 px-4 py-2 text-xs">
